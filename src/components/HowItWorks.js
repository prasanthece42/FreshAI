...
const steps = [
  {
    ...
    icon: <CheckCircle className="text-[#6246ea] w-6 h-6" />,
  },
  {
    title: 'Train Your AI',
    ...
    icon: <BrainCircuit className="text-[#6246ea] w-6 h-6" />,
  },
  {
    ...
    icon: <Send className="text-[#6246ea] w-6 h-6" />,
  },
  {
    ...
    icon: <BarChart3 className="text-[#6246ea] w-6 h-6" />,
  },
]
